...
def train(args):
    ...
    def acc_bowser(dict_pairs):
        ...
        return acc
    if args.ineq == 1:
        vocab_file = 'data/para_preprocessed/' + args.domain + '/vocab_ineq.p'
        
    elif args.recomb == 1:
        vocab_file = 'data/para_preprocessed/' + args.domain + '/vocab_recomb.p'
    else:
        vocab_file = 'data/para_preprocessed/' + args.domain + '/vocab.p'
    word_vectors = None
    if args.word2vec == 1:
        word_vectors = cPickle.load(open('data/para_preprocessed/' + args.domain + '/word2vec.p', 'rb'))
    ...
    #train_data_file = 'data/para_preprocessed/recipes_train_v1.json'
    #test_data_file = 'data/para_preprocessed/recipes_test_v1.json'
    train_data_file = 'data/para_preprocessed/' + args.train_data_file #should add args.domain as folder 
