...
class CopyDecoder(nn.Module):
    def __init__(self, vocab_size, embed_size, hidden_size, attn_type = 'concat', max_oovs=12, bi =0):
        ...
        # weights
        self.attn = Attn('concat', hidden_size, bi=bi)
...
# =============================================================================
    ...
    def forward(self, input_idx, encoded, encoded_idx, prev_state, weighted, order, X_lengths=None):
        ...
        score_c = F.tanh(self.Wc(encoded.contiguous().view(-1,hidden_size*2))) # [b*seq x hidden_size *3]
        score_c = score_c.view(b,-1,hidden_size*3) # [b x seq x hidden_size*3]
